...
function loadNCPData(){
  ...
  db.ref('ncp_data').on('value', function(snap){
    ...
    buildNCPTab();
    // Rafraichit le cockpit "Vue d'ensemble" (section "Derniers NCP -- AW3 P5")
    // a chaque chargement NCP -- meme schema que loadArretsInpak()/loadBulkData(),
    // aucune donnee recalculee ici.
