...
function updKPI(){
  ...
  applyOverviewAccess();
  // Rafraichit le cockpit "Vue d'ensemble" (sections "A surveiller" et "Bradford a
  // surveiller") a chaque recalcul Bradford -- meme schema de rafraichissement que
  // loadArretsInpak()/loadBulkData(), aucune donnee recalculee ici.
