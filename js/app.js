...
.s-kt{background:rgba(168,131,89,.25);color:#e8c9a0;font-weight:700}
...
var OPTS={TL:['TL','ziek','verlof','recup'],INPAK:['coordinateur','31/32','33/34','35/36','extra','Labo','Karton','AW1','AW2','ziek','verlof','recup'],Prod:['Prod','Labo','Karton','ziek','verlof','recup'],Unit:['Batter','Cleaning','Inpak','Bulk','Karton','AW1','AW2','ziek','verlof','recup']};
...
function sCls(v){var m={'TL':'tl','coordinateur':'coord','31/32':'31','33/34':'33','35/36':'35','extra':'ex','Prod':'pr','Labo':'lb','Batter':'bt','Cleaning':'cl','Inpak':'ip','Bulk':'bk','ziek':'zk','verlof':'vl','recup':'rc','AW1':'aw1','AW2':'aw2','Karton':'kt'};return 's-'+(m[v]||'em');}
...
function buildNCPTab(){
  ...
  var filtres = NCP_DATA.filter(function(r){
      if(NCP_FILTRE_UNITE !== 'all' && ncpUniteEffective(r) !== NCP_FILTRE_UNITE) return false;
